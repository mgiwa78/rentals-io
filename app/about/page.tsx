                ...
                <div className="col-lg-6">
                  <div className="pl-25">
                    ...
                    <div className="carausel-3-columns-cover position-relative">
                      ...
                      >
                        <img src="/imgs/page/about-2.png" alt="" />
                        <img src="/imgs/page/about-3.png" alt="" />
                        <img src="/imgs/page/about-4.png" alt="" />
                        <img src="/imgs/page/about-2.png" alt="" />
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="row">
                      <div className="col-lg-6 col-md-6">
                        <div className="team-card">
                          <img src="/imgs/page/about-6.png" alt="" />
                      ...
                      <div className="col-lg-6 col-md-6">
                        <div className="team-card">
                          <img src="/imgs/page/about-8.png" alt="" />
                          <div className="content text-center">
